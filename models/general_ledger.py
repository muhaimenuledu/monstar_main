        ...
        for rec in self:
            ...
            for account in accounts:
                ...
                header = "| {account} | {date} | {ref} | {label} | {group} | {partner} | {counter} | {amount_dr} | {amount_cr} | {balance} |".format(
                    ...
                    partner="Partner".center(widths["partner"]),  # NEW HEADER
                ...
                for line in move_lines:
                    ...
                    partner_name = (line.partner_id.name or "Unavailable")[:widths["partner"]]  # NEW DATA
                    ...
                    row = "| {account} | {date} | {ref} | {label} | {group} | {partner} | {counter} | {amount_dr} | {amount_cr} | {balance} |".format(
                        ...
                        partner=partner_name.ljust(widths["partner"]),  # NEW COLUMN
            ...
            for line in breakdown:
                if line.startswith("ACCOUNT_HEADER||"):
                    ...
                    html += f"<tr style='background:#a0c4ff;'><td colspan='10'><strong>{account_name}</strong></td></tr>"  # colspan updated
